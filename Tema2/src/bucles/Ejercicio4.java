...
public class Ejercicio4 {
	...
	public static void main(String[] args) {
		 ...
		 * vez al usuario.
		 * 
		 * Prueba 2: introducir valroes válidos (Ej. 6 y 8), debe mostrar el mcm de
		 * ambos. Imprime 24, es correcto.
		 */
		...
		//Calculamos el mcm entre A y B
		mcm = (numA * numB) / mcd; 
		
		// Imprimimos el resultado
		System.out.println("El mcm de " + numA + " y " + numB + " es: " + mcm);
